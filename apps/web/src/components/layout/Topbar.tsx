  ...
  return (
    <header className="h-16 flex items-center justify-between px-6 bg-surface-800 border-b border-surface-500/30 flex-shrink-0">
      ...
      <div className="flex items-center gap-2 bg-surface-700 border border-surface-500/60 rounded-lg px-3 py-2 w-72 group focus-within:border-brand-500/50 transition-colors">
        <Search size={14} className="text-text-muted group-focus-within:text-brand-400 transition-colors" />
        <input
          id="global-search"
          type="text"
      ...
      <div className="flex items-center gap-3">
        ...
        {/* Notifications */}
        <button id="notifications" className="relative w-9 h-9 flex items-center justify-center rounded-lg hover:bg-surface-600 transition-colors text-text-secondary hover:text-white">
          <Bell size={16} />
        ...
        <button
          ...
          className="flex items-center gap-2 text-sm text-text-secondary hover:text-white px-3 py-2 rounded-lg hover:bg-surface-600 transition-colors"
        >
          <LogOut size={15} />
          Logout
        </button>
